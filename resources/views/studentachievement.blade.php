                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" id="headingReject">
                                <h5 class="mb-0">
                                    <button class="btn btn-link" data-toggle="collapse" data-target="#collapseReject"
                                        aria-expanded="false" aria-controls="collapseReject">
                                        Rejected Achievements
                                    </button>
                                </h5>
                            </div>
                            <div id="collapseReject" class="collapse" aria-labelledby="headingReject"
                                data-parent="#accordion">
                                <div class="card-body">
