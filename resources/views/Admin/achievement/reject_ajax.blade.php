...
@else
    <form action="{{ url('/Admin/achievement/' . $achievement->prestasi_id . '/reject_ajax') }}" method="POST" id="form-reject">
        @csrf
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        ...
                        Apakah Anda ingin menolak prestasi seperti di bawah ini? Status akan diubah menjadi <strong>Rejected</strong>. Silakan masukkan alasan penolakan.
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="reject_note" name="reject_note" rows="3" placeholder="Masukkan alasan penolakan..." required></textarea>
