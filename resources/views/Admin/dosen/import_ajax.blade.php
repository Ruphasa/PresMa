<form action="{{ secure_url('/dosen/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ secure_asset('template_dosen.xlsx') }}" class="btn btn-info btn-sm" download><i
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            if (typeof tableDosen !== 'undefined') {
