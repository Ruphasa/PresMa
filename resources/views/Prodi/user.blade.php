...
                               <div id="collapseMahasiswa" class="collapse show" aria-labelledby="headingMahasiswa" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <div id="toolbar-mahasiswa" class="d-flex gap-2 mb-3">
                                    <button onclick="modalAction('{{ url('Admin/mahasiswa/create_ajax') }}')" class="btn btn-success">Tambah Data</button>
                                    <a href="{{ url('Admin/mahasiswa/export_pdf') }}" class="btn btn-primary" download>Export PDF</a>
                                    <button onclick="modalAction('{{ url('Admin/mahasiswa/import_pdf') }}')" class="btn btn-info">Import PDF</button>
                                </div>
...
                                </h5>
                            </div>
                            <div id="collapseDosen" class="collapse" aria-labelledby="headingDosen"
                                data-parent="#accordion">
                                <div class="card-body">
                                       {{-- Tombol Aksi --}}
                                <div id="toolbar-dosen" class="d-flex gap-2 mb-3">
                                    <button onclick="modalAction('{{ url('Admin/dosen/create_ajax') }}')" class="btn btn-success">Tambah Data</button>
                                    <a href="{{ url('Admin/dosen/export_pdf') }}" class="btn btn-primary" download>Export PDF</a>
                                    <button onclick="modalAction('{{ url('Admin/dosen/import_pdf') }}')" class="btn btn-info">Import PDF</button>
                                </div>
...
                                <div class="card-body">
                                ...
                                <div id="toolbar-admin" class="d-flex gap-2 mb-3">
                                    <button onclick="modalAction('{{ url('Admin/admin/create_ajax') }}')" class="btn btn-success">Tambah Data</button>
                                    <a href="{{ url('Admin/admin/export_pdf') }}" class="btn btn-primary" download>Export PDF</a>
                                    <button onclick="modalAction('{{ url('Admin/admin/import_pdf') }}')" class="btn btn-info">Import PDF</button>
                                </div>
